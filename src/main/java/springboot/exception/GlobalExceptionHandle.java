...
public class GlobalExceptionHandle {
    ...
    @ExceptionHandler(value = IllegalArgumentException.class)// 拦截所有异常, 这里只是为了演示，一般情况下一个方法特定处理一种异常
    ...
    public ResponseEntity<ErrorResponse> exceptionHandler2(Exception e) {
